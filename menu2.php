    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample03">
            <ul class="navbar-nav ms-auto mb-2 mb-sm-0">
                <li class="nav-item">
                    <a class="nav-link active nav-item-custom" aria-current="page" href="cover.php">Приветсвие</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu navbar-custom" aria-labelledby="dropdown03">
                        <li><a class="dropdown-item nav-item-custom" href="index.php#portfolio">Полное Portfolio</a></li>
                ...
                <li class="nav-item">
                    <a class="nav-link nav-item-custom" href="index.php#contact">Контакты</a>
                </li>
            </ul>
        </div>
    </div>
